...
# Counts by virus 'class'

SELECT virus_taxonomy.tax_class, COUNT(*)
FROM digs_results, virus_taxonomy
WHERE digs_results.assigned_name = virus_taxonomy.name
GROUP BY virus_taxonomy.tax_class


# Counts by virus 'class' and virus family

SELECT  virus_taxonomy.tax_class, virus_taxonomy.family, COUNT(*)
FROM digs_results, virus_taxonomy
WHERE digs_results.assigned_name = virus_taxonomy.name
GROUP BY virus_taxonomy.tax_class, virus_taxonomy.family
ORDER BY virus_taxonomy.tax_class, virus_taxonomy.family;


# Counts by host class, virus 'class' and virus family

SELECT host_taxonomy.tax_class, virus_taxonomy.tax_class, virus_taxonomy.family, COUNT(*)
FROM digs_results, virus_taxonomy, host_taxonomy
WHERE digs_results.assigned_name = virus_taxonomy.name
AND host_taxonomy.species = organism
GROUP BY host_taxonomy.tax_class, virus_taxonomy.tax_class, virus_taxonomy.family
ORDER BY host_taxonomy.tax_class, virus_taxonomy.tax_class, virus_taxonomy.family


# Counts by host class and virus 'class'

SELECT host_taxonomy.tax_class, virus_taxonomy.tax_class, COUNT(*)
FROM digs_results, virus_taxonomy, host_taxonomy
WHERE digs_results.assigned_name = virus_taxonomy.name
AND host_taxonomy.species = organism
GROUP BY host_taxonomy.tax_class, virus_taxonomy.tax_class
ORDER BY host_taxonomy.tax_class, virus_taxonomy.tax_class
